...
<nav class="col-md-2 d-none d-md-block bg-light sidebar">
  <div class="sidebar-sticky">
    ...
    <ul class="nav flex-column mb-2">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('supervisor.create')}}">
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{ __('Register Supervisor') }}</div>
                        ...
                        <form method="POST" action="{{ route('register.supervisor')}}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary" style="background-color:#59BFC9;border:0">
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            </div>
